    ...
    <nav className="bg-charcoal text-white sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between h-16">
        ...
        <div className="hidden md:flex items-center gap-8">
          ...
          <a href="tel:5558765432" className="bg-teal hover:bg-teal-dark text-white text-sm font-semibold px-4 py-2 rounded-lg transition-colors">
            (555) 876-5432
          </a>
        </div>
      ...
      {open && (
        <div className="md:hidden px-4 pb-4 space-y-2">
          ...
          <a href="tel:5558765432" className="block bg-teal text-white text-sm font-semibold px-4 py-2 rounded-lg text-center">
            (555) 876-5432
          </a>
        </div>
      )}
