...
export default function TestimonialCard({ quote, name, location, rating }: TestimonialCardProps) {
  return (
    <div className="bg-white rounded-2xl p-10 shadow-sm border border-gray-100 transition-all duration-300 hover:-translate-y-1 hover:shadow-lg relative">
      ...
      <p className="text-gray-700 text-lg mb-8 leading-relaxed relative">&ldquo;{quote}&rdquo;</p>
