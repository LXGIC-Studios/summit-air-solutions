...
const services = [
  { icon: "🔥", title: "Heating", description: "Furnace installation, repair, and maintenance to keep your home warm all winter long." },
  { icon: "❄️", title: "Cooling", description: "AC installation, tune-ups, and emergency repairs for reliable summer comfort." },
  { icon: "🌬️", title: "Air Quality", description: "Air purifiers, humidifiers, and duct cleaning for healthier indoor air." },
  { icon: "🛡️", title: "Maintenance Plans", description: "Preventive maintenance plans that save money and extend equipment life." },
];
  ...
  return (
    <>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 md:py-32">
          <div className="max-w-2xl">
            ...
            <div className="flex flex-wrap gap-4">
              <Link href="/contact" className="bg-teal hover:bg-teal-dark text-white font-semibold px-6 py-3 rounded-lg transition-colors">
                Schedule Service
              </Link>
              <a href="tel:5558765432" className="border border-white/30 text-white font-semibold px-6 py-3 rounded-lg hover:bg-white/10 transition-colors">
                Call (555) 876-5432
              </a>
            </div>
          </div>
      ...
      <section className="py-16 bg-slate-light">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-charcoal text-center mb-12">Why Choose Summit</h2>
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-charcoal text-center mb-12">What Our Customers Say</h2>
      ...
      <section className="py-16 bg-slate-light">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <Link href="/contact" className="inline-block bg-teal hover:bg-teal-dark text-white font-semibold px-6 py-3 rounded-lg transition-colors">
            Learn More
          </Link>
        </div>
      </section>
