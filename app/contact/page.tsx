    ...
    <>
      <section className="bg-charcoal py-28 md:py-32 relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-gray-400 max-w-2xl text-xl font-light">Ready to schedule service? Fill out the form below or give us a call.</p>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-16">
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              <div className="bg-teal rounded-2xl p-10 text-white">
                <div className="text-sm font-medium mb-2 uppercase tracking-widest text-white/70">Call Us Now</div>
              ...
              {/* Hours */}
              <div className="bg-slate-light rounded-2xl p-10">
