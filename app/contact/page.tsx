    ...
    <>
      <section className="bg-charcoal py-20 md:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-gray-300 max-w-2xl text-lg">Ready to schedule service? Fill out the form below or give us a call.</p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-14">
            ...
            <div className="lg:col-span-3">
              <h2 className="text-2xl font-bold text-charcoal mb-8">Request Service</h2>
              <ContactForm />
            </div>
            ...
            <div className="lg:col-span-2 space-y-8">
              {/* Phone */}
              <div className="bg-teal rounded-xl p-8 text-white">
              ...
              {/* Hours */}
              <div className="bg-slate-light rounded-xl p-8">
                <h3 className="font-bold text-charcoal mb-4">Business Hours</h3>
                <ul className="space-y-3 text-sm text-gray-600">
                  <li className="flex justify-between"><span>Monday &ndash; Friday</span><span className="font-medium">7:00 AM &ndash; 7:00 PM</span></li>
                  <li className="flex justify-between"><span>Saturday</span><span className="font-medium">8:00 AM &ndash; 5:00 PM</span></li>
                  <li className="flex justify-between"><span>Sunday</span><span className="font-medium">Closed</span></li>
                </ul>
              </div>

              {/* Emergency */}
              <div className="border-2 border-teal rounded-xl p-8">
              ...
              <div className="bg-slate-light rounded-xl p-8">
                ...
                <p className="text-sm text-gray-500 mt-3">info@summitairsolutions.com</p>
              </div>
            </div>
          </div>
        </div>
