...
const certs = [
  { label: "EPA Certified", icon: "✅" },
  { label: "NATE Certified", icon: "🏅" },
  { label: "BBB A+ Rating", icon: "⭐" },
  { label: "Fully Licensed & Insured", icon: "🛡️" },
];
    ...
    <>
      <section className="bg-charcoal py-16 md:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-gray-300 max-w-2xl">Keeping homes comfortable since 2009.</p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <div className="space-y-4 text-gray-600 leading-relaxed">
              ...
              <p>What started as a one-truck operation has grown into a full-service HVAC company serving over 5,000 homes across the Denver metro area. Despite our growth, we&apos;ve never lost sight of what matters most — treating every customer like family.</p>
      ...
      <section className="py-16 bg-slate-light">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-charcoal text-center mb-12">Certifications & Accreditations</h2>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {certs.map((c) => (
              <div key={c.label} className="bg-white rounded-xl p-6 text-center shadow-sm border border-gray-100">
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-charcoal text-center mb-12">Meet Our Team</h2>
